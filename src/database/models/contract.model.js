...
module.exports = (sequelize) => {
  class Contract extends Model {
    static associate(models) {
      ...
      Contract.hasMany(models.ContractActivityReport, { foreignKey: 'contract_id', as: 'reports' });

      Contract.hasMany(models.ContractObligation, { foreignKey: 'contract_id', as: 'obligations' });
    }
  }
  ...
  Contract.init({
    ...
    stage: {
      type: DataTypes.ENUM('pre_contractual','contractual'),
      allowNull: false,
      defaultValue: 'pre_contractual'
    },
    ...
    supervisor_name: { type: DataTypes.STRING, allowNull: true },
    supervisor_id: { type: DataTypes.STRING, allowNull: true },
    supervisor_position: { type: DataTypes.STRING, allowNull: true },

    // Contratista
    contractor_name: { type: DataTypes.STRING, allowNull: true },
    contractor_identification: { type: DataTypes.STRING, allowNull: true },
    contractor_phone: { type: DataTypes.STRING, allowNull: true },
    contractor_email: { type: DataTypes.STRING, allowNull: true },
